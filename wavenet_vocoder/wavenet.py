...
class WaveNet(nn.Module):
    ...
    def forward(self, x, c=None, g=None, softmax=False, use_skip=True):
        """Forward step
    ...
    def incremental_forward(self, initial_input=None, c=None, g=None, T=100, test_inputs=None,
                            tqdm=lambda x: x, softmax=True, quantize=True, log_scale_min=-7.0):
